...
const quizData: QuizData[] = [
  // SINGLE CHOICE QUESTIONS (1-25)
  {
    ...
    difficulty: "easy",
    explanation:
      "Modern commercial sows typically produce 10-12 piglets per litter due to genetic improvements and proper nutrition management.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Landrace pigs are specifically bred for their lean meat quality and are particularly valued for bacon production.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Growing pigs require 14-18% protein in their diet to support rapid muscle development and growth.",
    options: [
  ...
  },
  {
    ...
    difficulty: "easy",
    explanation:
      "Market weight for pigs is typically 220-280 lbs, which provides optimal feed conversion efficiency and meat quality.",
    options: [
  ...
  },
  {
    ...
    difficulty: "easy",
    explanation:
      "Partially slatted floors provide good manure management while maintaining animal comfort and welfare.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Vitamin D deficiency leads to poor calcium absorption, resulting in rickets and weak bone development.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Water pH between 6.5-7.5 is optimal for pig health and prevents equipment corrosion and bacterial growth.",
    options: [
  ...
  },
  {
    ...
    difficulty: "easy",
    explanation:
      "14 teats allows a sow to adequately nurse larger litters, which is important for modern prolific genetics.",
    options: [
  ...
  },
  {
    ...
    difficulty: "hard",
    explanation:
      "PRRS is characterized by respiratory problems in pigs of all ages and reproductive failure in breeding stock.",
    options: [
      { text: "Diarrhea", is_correct: false },
      {
        text: "Respiratory distress and reproductive failure",
        is_correct: true,
      },
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Environmental enrichment provides mental stimulation and reduces stress-related behaviors like tail biting.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Normal pig body temperature is 102.5°F (39.2°C), which is higher than human body temperature.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Lysine is an essential amino acid that promotes lean muscle growth and improves feed conversion efficiency.",
    options: [
  ...
  },
  {
    ...
    difficulty: "hard",
    explanation:
      "24 square feet per sow in group housing allows for natural movement and social interaction while meeting welfare standards.",
    options: [
  ...
  },
  {
    ...
    difficulty: "hard",
    explanation:
      "Erysipelas causes characteristic diamond-shaped skin lesions and can affect multiple organ systems.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "6-8% crude fiber provides digestive health benefits while maintaining optimal nutrient digestibility.",
    options: [
  ...
  },
  {
    ...
    difficulty: "easy",
    explanation:
      "Cleaning after each litter prevents disease transmission and provides a hygienic environment for newborn piglets.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "The estrus cycle in sows averages 21 days, which is important for breeding management and timing.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Iron deficiency is common in nursing piglets because sow's milk is low in iron, requiring supplementation.",
    options: [
  ...
  },
  {
    ...
    difficulty: "hard",
    explanation:
      "The pig's stomach is relatively small (0.5-1% of body weight), reflecting their simple stomach digestion system.",
    options: [
  ...
  },
  {
    ...
    difficulty: "hard",
    explanation:
      "A comprehensive vaccination program including PRRS, Mycoplasma, and PCV2 is standard at 2-3 weeks of age.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "4-5 square feet per pig in the nursery allows for proper growth while maintaining good air quality and comfort.",
    options: [
  ...
  },
  {
    ...
    difficulty: "easy",
    explanation:
      "Dent corn has the optimal starch content and digestibility for pig nutrition and feed conversion.",
    options: [
  ...
  },
  {
    ...
    difficulty: "easy",
    explanation:
      "Creep feeders provide high-quality starter feed to nursing piglets, supplementing sow's milk and preparing for weaning.",
    options: [
      { text: "Feed pregnant sows", is_correct: false },
      {
        text: "Provide supplemental feed to nursing piglets",
        is_correct: true,
      },
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Carbon dioxide is the primary gas produced during manure decomposition, though ammonia and methane are also significant.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "8-9 months allows gilts to reach proper physical maturity and weight for successful breeding and farrowing.",
    options: [
  ...
  // MULTIPLE CHOICE QUESTIONS (26-35) - Select all that apply
  {
    ...
    difficulty: "medium",
    explanation:
      "All these factors significantly impact how efficiently pigs convert feed into body weight gain.",
    options: [
  ...
  },
  {
    ...
    difficulty: "easy",
    explanation:
      "These are classic signs of heat stress that require immediate attention to prevent serious health issues.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Comprehensive biosecurity requires multiple layers of protection to effectively prevent disease transmission.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "These nutrients work together to ensure proper bone formation and strength in growing pigs.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "These practices address the main causes of piglet mortality in the first weeks of life.",
    options: [
  ...
  },
  {
    ...
    difficulty: "easy",
    explanation:
      "All these environmental factors significantly impact pig health, welfare, and performance.",
    options: [
  ...
  },
  {
    ...
    difficulty: "hard",
    explanation:
      "These are reportable diseases due to their serious economic and public health implications.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "These breeding methods are practical and economical for commercial pig production operations.",
    options: [
  ...
  },
  {
    ...
    difficulty: "easy",
    explanation:
      "These ingredients provide readily available carbohydrates and fats for energy production.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "All these parameters affect pig health and performance and should be monitored regularly.",
    options: [
  ...
  // TRUE/FALSE QUESTIONS (36-50)
  {
    ...
    difficulty: "easy",
    explanation:
      "Pigs naturally prefer to keep their sleeping and eating areas separate from their elimination areas when space allows.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Diet should be adjusted based on stage - gestation diet differs from lactation diet in energy and protein content.",
    options: [
  ...
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Castration prevents the development of compounds that cause boar taint, improving meat acceptability.",
    options: [
      { text: "True", is_correct: true },
      { text: "False", is_correct: false },
    ],
  },
  {
    ...
    difficulty: "hard",
    explanation:
      "Unlike humans, pigs can synthesize vitamin C internally and do not require dietary supplementation.",
    options: [
      { text: "True", is_correct: true },
      { text: "False", is_correct: false },
    ],
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "The trend is toward group housing systems that allow for more natural behavior and improved welfare.",
    options: [
      { text: "True", is_correct: false },
      { text: "False", is_correct: true },
    ],
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Growth promotion use of antibiotics has been largely eliminated due to antibiotic resistance concerns.",
    options: [
      { text: "True", is_correct: false },
      { text: "False", is_correct: true },
    ],
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Pigs actually have good hearing but relatively poor eyesight compared to other farm animals.",
    options: [
      { text: "True", is_correct: false },
      { text: "False", is_correct: true },
    ],
  },
  {
    ...
    difficulty: "easy",
    explanation:
      "Genetic selection has dramatically improved litter size and sow productivity over the past decades.",
    options: [
      { text: "True", is_correct: true },
      { text: "False", is_correct: false },
    ],
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Even in pasture systems, pigs typically require supplemental feeding to meet nutritional requirements and growth targets.",
    options: [
      { text: "True", is_correct: false },
      { text: "False", is_correct: true },
    ],
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Barrows and gilts have different nutritional requirements, so separate feeding can optimize feed conversion.",
    options: [
      { text: "True", is_correct: true },
      { text: "False", is_correct: false },
    ],
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Zinc oxide is effective in preventing post-weaning diarrhea and supporting intestinal health in young pigs.",
    options: [
      { text: "True", is_correct: true },
      { text: "False", is_correct: false },
    ],
  },
  {
    ...
    difficulty: "hard",
    explanation:
      "Pigs typically require more water per pound of body weight than cattle due to their higher metabolic rate.",
    options: [
      { text: "True", is_correct: false },
      { text: "False", is_correct: true },
    ],
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "Tail biting has multiple causes including nutrition, environment, stress, and genetics - not just overcrowding.",
    options: [
      { text: "True", is_correct: false },
      { text: "False", is_correct: true },
    ],
  },
  {
    ...
    difficulty: "hard",
    explanation:
      "First-parity gilts typically have smaller litters than mature sows due to their developing reproductive capacity.",
    options: [
      { text: "True", is_correct: true },
      { text: "False", is_correct: false },
    ],
  },
  {
    ...
    difficulty: "medium",
    explanation:
      "While indoor systems are common, outdoor access systems still exist and welfare concerns continue to be debated.",
    options: [
      { text: "True", is_correct: false },
      { text: "False", is_correct: true },
    ],
...
async function run() {
  try {
    ...
    if (!adminUser) {
      ...
      if (!adminRole || !level) {
        throw new Error(
          "Required admin role or level not found. Please run seeders first."
        );
      }
    ...
    if (!pigFarmingTag) {
      pigFarmingTag = await BestPracticeTag.create({
        name: "Pig Farming",
        description:
          "Comprehensive pig farming practices, nutrition, health management, and production systems",
        is_active: true,
      });
      console.log("✅ Created Pig Farming tag");
    }

    // Check if quiz already exists and delete it
    ...
    if (existingQuiz) {
      console.log(
        "⚠️ Comprehensive Pig Farming Quiz already exists. Deleting and recreating..."
      );
    ...
    const quiz = await Quiz.create({
      ...
      description:
        "A comprehensive 50-question quiz covering all aspects of pig farming including nutrition, breeding, health management, housing, and production systems. Designed for farmers, students, and agricultural professionals.",
    ...
    for (let i = 0; i < quizData.length; i++) {
      ...
      console.log(
        `✅ Created question ${i + 1}: ${questionData.type} with ${
