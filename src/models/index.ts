...
ContentTagAssignment.belongsTo(Content, { foreignKey: 'content_id', as: 'content' });
ContentTagAssignment.belongsTo(PostTag, { foreignKey: 'tag_id', as: 'tag' });
Content.hasMany(ContentTagAssignment, { foreignKey: 'content_id', as: 'tagAssignments' });
PostTag.hasMany(ContentTagAssignment, { foreignKey: 'tag_id', as: 'contentAssignments' });
